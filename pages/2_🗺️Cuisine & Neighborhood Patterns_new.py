...
with st.container(border=True):
    ...
    st.markdown(
        """
**Key takeaway:** Inspection outcomes vary jointly by borough and cuisine. Brooklyn and Queens tend to show higher inspection scores across several cuisine categories, suggesting relatively weaker inspection performance in those borough-cuisine combinations. Manhattan appears more stable, with most cuisines staying in a moderate range. The Bronx is broadly similar, though categories such as Indian and Thai stand out with higher scores. Staten Island shows more uneven values, which should be interpreted cautiously because smaller restaurant counts can make averages fluctuate more.
"""
    )
