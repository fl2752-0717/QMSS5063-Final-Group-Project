...
def find_csv_path():
    ...
    candidates = [
        ...
        base_dir / "DOHMH_New_York_City_Restaurant_Inspection_Results.csv",
        base_dir / "data" / "DOHMH_New_York_City_Restaurant_Inspection_Results_20260416.csv",
        base_dir / "data" / "DOHMH_New_York_City_Restaurant_Inspection_Results.csv",
    ]
    for p in candidates:
        if p.exists():
            return p
    raise FileNotFoundError(
        "CSV file not found. Put the inspection CSV in the project root or data/ folder."
    )
